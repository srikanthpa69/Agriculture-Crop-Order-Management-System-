...
background-attachment: fixed;">
  <div class="container">
        <div class="tablename">
             <h3 align=center>Crops registered</h3>
        </div>
      ...
      <table class="table table-striped table-bordered">
        ...
        <tr>
         ...
         if($result->num_rows>0)
         {
           ...
           {
             $cr_id=$row['crop_id'];
             echo "<tr><td>".$row["crop_id"]."</td><td>".$row["crop_name"]."</td><td>".$row["crop_type"]."</td><td>".$row["crop_category"]."</td><td>".$row["farmer_id"]."</td><td>".$row["quantity"]."</td><td>".$row["cost"]."</td><td><form action='admincropdelete.php' method='post'><input type='submit' name='del' value=".$cr_id." style='color:red;background:red;width: 80px;height:25px;border-radius: 4px;border-color:red;margin-left: 30px;'></form></td><tr>";
